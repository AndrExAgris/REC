...
c1 = net.addController('c1', controller=mininet.node.RemoteController, ip='192.168.0.101', port=6653)
PC0 = net.addHost('PC0', ip='192.168.0.1')
PC1 = net.addHost('PC1', ip='192.168.0.2')
PC2 = net.addHost('PC2', ip='192.168.0.3')
PC3 = net.addHost('PC3', ip='192.168.0.4')
PC4 = net.addHost('PC4', ip='192.168.0.5')
PC5 = net.addHost('PC5', ip='192.168.0.6')
PC6 = net.addHost('PC6', ip='192.168.0.7')
PC7 = net.addHost('PC7', ip='192.168.0.8')
PC8 = net.addHost('PC8', ip='192.168.0.9')
PC9 = net.addHost('PC9', ip='192.168.0.10')
