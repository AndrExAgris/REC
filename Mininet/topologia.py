...
PC3 = net.addHost('PC3', ip='192.168.20.2')
PC4 = net.addHost('PC4', ip='192.168.30.1')
PC5 = net.addHost('PC5', ip='192.168.30.2')
PC6 = net.addHost('PC6', ip='192.168.40.1')
PC7 = net.addHost('PC7', ip='192.168.40.2')
PC8 = net.addHost('PC8', ip='192.168.50.1')
PC9 = net.addHost('PC9', ip='192.168.50.2')
