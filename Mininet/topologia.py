...
PC0 = net.addHost('PC0', ip='10.10.10.1')
PC1 = net.addHost('PC1', ip='10.10.10.2')
PC2 = net.addHost('PC2', ip='10.10.20.1')
PC3 = net.addHost('PC3', ip='10.10.20.2')
PC4 = net.addHost('PC4', ip='10.10.30.1')
PC5 = net.addHost('PC5', ip='10.10.30.2')
PC6 = net.addHost('PC6', ip='10.10.40.1')
PC7 = net.addHost('PC7', ip='10.10.40.2')
PC8 = net.addHost('PC8', ip='10.10.50.1')
PC9 = net.addHost('PC9', ip='10.10.50.2')
